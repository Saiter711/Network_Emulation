    ...
    class Graf
    {
        ...
        public List<int> dijkstra(int a, int x)
        {
            ...
            if (a != x)
            {
                ...
                for (int i = 0; i < CCRC2.MAXSLOTS; i++)
                    holes[a - 1].Add(i);
...
//Console.WriteLine("Tablica d: " + d[i]);
             ...
             //   Console.WriteLine("--------------------------------------------------");
              ...
              //  Console.WriteLine("--------------------------------------------------");
               ...
               // Console.WriteLine("--------------------------------------------------");
                ...
                int lastestNode = x;
                int nextNodeToAdd = 0;
                foreach (Krawedz kraw1 in krawedzie)
                {
                    //Console.WriteLine("Krawedz id: " + kraw1.Podajindeks() + " wezel 1 i wezel 2 " + kraw1.PodajPoczatek() + " " + kraw1.PodajKoniec());
                }
                while (a != lastestNode)
                {
                    if (podajWezel(lastestNode) == null)
                    {
                        Console.WriteLine("I do not have such a node.1");
                    }
                    else
                    {
                        dijkstra2.wezly.Add(podajWezel(lastestNode));
                    ...
                    dijkstra2.krawedzie.Add(podajKrawedz1(nextNodeToAdd, lastestNode));
        ...
        public List<int> dijkstraSzczeliny(int a, int x)
        {
            ...
            if (a != x)
            {
                        ...
                        for (int i = 0; i < krawedzie.Count; i++)
                        {
                            if (krawedzie[i].PodajPoczatek() == actualEdge.PodajKoniec())
                            {
                                ...
                                if (war2 == false)
                                {
                                    ...
                                    for (int k = 0; k < CCRC2.MAXSLOTS; k++)
                                        s1.Add(k);
             ...
             //   Console.WriteLine("Tablica dostepnych szczelin:");
                foreach (SortedSet<int> aa in holes)
                {
                ...
                List<int> returnValue = new List<int>();
              //  Console.WriteLine("TTTTTT: " + holes[x - 1]);
                returnValue.Add(d[x - 1]);
                returnValue.Add(-777);
                foreach (int number in returnContinuousSzczeliny(holes[x - 1]))
                {
